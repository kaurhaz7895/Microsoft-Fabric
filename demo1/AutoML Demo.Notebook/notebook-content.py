...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "42191221-c276-4a35-b946-3cf2b25e2f68",
# META       "default_lakehouse_name": "DiabetesData",
# META       "default_lakehouse_workspace_id": "cce5dad0-8c26-4c65-ac57-75163073d0bd",
# META       "known_lakehouses": [
# META         {
# META           "id": "42191221-c276-4a35-b946-3cf2b25e2f68"
# META         }
# META       ]
# META     }
# META   }
...
target_col = re.sub('[^A-Za-z0-9_]+', '_', "Y")
...
mlflow.set_experiment("AutoMLDemo-DiabetesRun")
...
settings = {
    ...
    "force_cancel": True, 
    "seed": 41 , # Random seed 
    "mlflow_exp_name": "AutoMLDemo-DiabetesRun",  # MLflow experiment name
...
with mlflow.start_run(run_name="AutoMLModel-DiabetesModel") as run:
    automl.fit(
        X_train=X_train, 
...
registered_model = mlflow.register_model(model_uri=model_path, name="AutoMLModel-DiabetesModel")
...
model_name = "AutoMLModel-DiabetesModel"
...
saved_name = "Tables/Diabetes_predictions".replace(".", "_")
